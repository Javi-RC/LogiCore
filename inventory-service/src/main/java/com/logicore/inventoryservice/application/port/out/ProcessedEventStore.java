...
/**
 * Outbound port for at-least-once idempotency: records which event ids have already been
 * processed so that a redelivered Kafka message is not applied twice.
 */
